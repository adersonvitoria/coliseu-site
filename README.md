...
- CTAs do hero ("coleção Nido/Colosseo"), busca, sacola, links do rodapé (troca, Livelo, consertos, corporativo) — tudo demonstra um fluxo diferente da Luiza.
...
- `js/luiza-engine.js` — engine da Luiza (catálogo `PRODUTOS`, lojas `FILIAIS`, cérebro `responder()`), extraída do projeto irmão `joalheria-bots`;
